...
Use the nested skill automatically when the task matches the auto-trigger rules in `AGENTS.md`.

For tasks inside the nested skill tree:

- keep repo-shared instructions in this file or `AGENTS.md`
- keep product guidance inside `./figma-to-ios-ui/SKILL.md` and its references
